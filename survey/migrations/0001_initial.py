    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principle1', models.DecimalField(blank=True, default=None)),
                ('principle2', models.DecimalField(blank=True, default=None)),
                ('principle3', models.DecimalField(blank=True, default=None)),
                ('principle4', models.DecimalField(blank=True, default=None)),
                ('principle5', models.DecimalField(blank=True, default=None)),
                ('principle6', models.DecimalField(blank=True, default=None)),
                ('principle7', models.DecimalField(blank=True, default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Evaluation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_first_used_technology', models.DecimalField(default=18)),
                ('competency_level', models.TextField(default='')),
                ('age_when_first_owned_device', models.DecimalField(default=18)),
