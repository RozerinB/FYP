    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', django_cryptography.fields.encrypt(models.CharField(default=None, max_length=100, primary_key=True, serialize=False))),
                ...
                ('usefulness_for_profession_reason', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('usefulness_for_researcher', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('usefulness_for_researcher_reason', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_non_western', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_non_western_reason', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_western', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_western_reason', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('feedback', django_cryptography.fields.encrypt(models.TextField(default=''))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('correlation', django_cryptography.fields.encrypt(models.BooleanField(default=False))),
                ('no_correlation_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('correlation_culture', django_cryptography.fields.encrypt(models.BooleanField(default=False))),
                ...
                ('representation_of_user', django_cryptography.fields.encrypt(models.BooleanField(default=False))),
                ('no_representation_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('generalisability', django_cryptography.fields.encrypt(models.BooleanField(default=False))),
