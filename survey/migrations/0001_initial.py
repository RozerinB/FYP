    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principle1', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle2', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle3', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle4', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle5', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle6', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ('principle7', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
            ],
        ),
        migrations.CreateModel(
            name='Evaluation',
            fields=[
                ...
                ('consent_form', django_cryptography.fields.encrypt(models.BooleanField(default=False))),
                ('usefulness_for_profession', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('usefulness_for_profession_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('usefulness_for_researcher', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('usefulness_for_researcher_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('design_for_non_western', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_non_western_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('design_for_western', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_for_western_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('design_globally', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('design_globally_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('feedback', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('created_on', django_cryptography.fields.encrypt(models.DateTimeField(auto_now_add=True))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('client_id', models.CharField(default=None, max_length=100, primary_key=True, serialize=False)),
                ('correlation', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_correlation_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('correlation_culture', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_correlation_culture_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('correlation_ethnicity', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_correlation_ethnicity_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('correlation_age', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_correlation_age_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('correlation_nationality', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_correlation_nationality_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('representation_of_user', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_representation_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('generalisability', django_cryptography.fields.encrypt(models.TextField(default=''))),
                ('no_generalisability_reason', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('feedback', django_cryptography.fields.encrypt(models.TextField(blank=True, default=''))),
                ('created_on', django_cryptography.fields.encrypt(models.DateTimeField(auto_now_add=True))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_when_first_owned_device', django_cryptography.fields.encrypt(models.DecimalField(blank=True, decimal_places=0, default=None, max_digits=10))),
                ...
                ('device_type_owned', django_cryptography.fields.encrypt(models.JSONField(default=str))),
                ('device_access', django_cryptography.fields.encrypt(models.JSONField(default=str))),
